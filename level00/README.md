...
When we look at the content of the file, there is the following text: cdiiddwpgswtgt. After using CyberChef, we can see the text use ROT11 to hide the following password: nottoohardhere
